...
{
    internal class GetMasterResponseParser : IResponseParser<IClusterMember>
    {
        #region Public Methods

        public IClusterMember Parse(IHttpWebResponse response)
        {
            return Parser<ClusterMember>.Parse(response, HttpStatusCode.OK);
        }
